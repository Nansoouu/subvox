...
Jede Übersetzung durchläuft 5 Schritte. So treibt die **Community** jeden einzelnen an.

> 💡 **Möchten Sie sehen, wie es unter der Haube funktioniert?** Die Pipeline ist vollständig Open Source unter [github.com/Nansoouu/subvox-pipeline](https://github.com/Nansoouu/subvox-pipeline). Sie können sie selbst ausführen, jede Codezeile überprüfen und beitragen.

### 1. Herunterladen
Ihre Video-URL wird über yt-dlp heruntergeladen. Community-Mitglieder können verschlüsselte Cookies teilen, um eingeschränkte Plattformen (YouTube usw.) freizuschalten.

**Sie verdienen:** Teilen Sie Ihre Cookies und werden Sie jedes Mal belohnt, wenn sie verwendet werden.
...
### Offizielle Solana-Wallets

| Netzwerk | Adresse | Zweck |
|---------|---------|---------|
| **Devnet** | Bald verfügbar | SUBTEST-Token, Testtransaktionen |
| **Mainnet** | Bald verfügbar | Zukünftiger SUBVOX-Token, Plattformumsätze |

> Dies sind die **einzigen offiziellen Subvox-Wallets**. Wir werden Sie niemals bitten, Gelder an eine andere Adresse zu senden. Achten Sie auf Betrüger.
...
Einige Plattformen (YouTube usw.) erfordern Authentifizierungs-Cookies, um Videos herunterzuladen. Teilen Sie Ihre verschlüsselten Cookies und verdienen Sie SUBVOX jedes Mal, wenn sie verwendet werden.

**So geht's:** Ihre Cookies werden mit Fernet (AES) verschlüsselt und sicher gespeichert. Sie können den Zugriff jederzeit widerrufen.
...
|----------|-------|
| Token-Name | SUBVOX |
| Netzwerk | Solana (Devnet zum Testen, Mainnet TBD) |
| Token-Adresse | Bald verfügbar |
| Dezimalstellen | 6 |

### Umsatzaufteilung pro Übersetzung
...
> **Wichtig:** SUBVOX ist ein Community-Utility-Token. Es hat keinen garantierten Geldwert. Zahlen Sie niemals Geld für SUBVOX.
...
| # | Sprache | README |
|---|----------|--------|
| 1 | Englisch | [README.md](/) |
| 2 | Französisch | [README.fr.md](docs/readmes/README.fr.md) |
| 3 | Spanisch | [README.es.md](docs/readmes/README.es.md) |
| 4 | Portugiesisch | [README.pt.md](docs/readmes/README.pt.md) |
| 5 | Deutsch | [README.de.md](docs/readmes/README.de.md) |
| 6 | Italienisch | [README.it.md](docs/readmes/README.it.md) |
| 7 | Niederländisch | [README.nl.md](docs/readmes/README.nl.md) |
| 8 | Polnisch | [README.pl.md](docs/readmes/README.pl.md) |
| 9 | Russisch | [README.ru.md](docs/readmes/README.ru.md) |
| 10 | Ukrainisch | [README.uk.md](docs/readmes/README.uk.md) |
| 11 | Arabisch | [README.ar.md](docs/readmes/README.ar.md) |
| 12 | Hindi | [README.hi.md](docs/readmes/README.hi.md) |
| 13 | Persisch | [README.fa.md](docs/readmes/README.fa.md) |
| 14 | Hebräisch | [README.he.md](docs/readmes/README.he.md) |
| 15 | Chinesisch (Vereinfacht) | [README.zh.md](docs/readmes/README.zh.md) |
| 16 | Japanisch | [README.ja.md](docs/readmes/README.ja.md) |
| 17 | Koreanisch | [README.ko.md](docs/readmes/README.ko.md) |
| 18 | Türkisch | [README.tr.md](docs/readmes/README.tr.md) |
| 19 | Vietnamesisch | [README.vi.md](docs/readmes/README.vi.md) |
