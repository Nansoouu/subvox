...
Lies die englische Haupt-README fur die vollstandige Version. Hier sind die wichtigen Informationen auf Deutsch.
...
**Mehr als 1800 Plattformen unterstutzt** via yt-dlp.

## Warum Subvox?

Video-Ubersetzung betrifft **Milliarden von Menschen**. Ein koreanisches Tutorial, eine deutsche Konferenz, ein arabischer Vortrag, ein spanischer Vlog. Sprache sollte nie eine Barriere sein.

**Das Problem:** Bestehende Tools (Veed, Kapwing, Descript, Opus Clip) begrenzen die Zeit, den Export und schliessen dich in teuren Abonnements ein.

**Die Losung:** Eine dezentralisierte Community, in der alle gewinnen.
...
Lies die [englische Haupt-README](../README.md) fur die vollstandige Dokumentation.
...
> Dieses Repository ist die **einzige offizielle Quelle** fur Subvox.
