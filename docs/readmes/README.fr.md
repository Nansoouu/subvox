...
<div align="center">
  <img src="https://raw.githubusercontent.com/Nansoouu/subvox/main/public/screenshots/download_subvox.png" alt="Mode téléchargement" style="border-radius:12px;border:1px solid rgba(255,255,255,0.1);max-width:100%;height:auto;margin-bottom:16px">
  <br/>
  <img src="https://raw.githubusercontent.com/Nansoouu/subvox/main/public/screenshots/translate_mode_subvox.png" alt="Mode traduction" style="border-radius:12px;border:1px solid rgba(255,255,255,0.1);max-width:100%;height:auto;margin-bottom:16px">
  <br/>
  <img src="https://raw.githubusercontent.com/Nansoouu/subvox/main/public/screenshots/reward_subvox.png" alt="Page des récompenses" style="border-radius:12px;border:1px solid rgba(255,255,255,0.1);max-width:100%;height:auto">
  <br/>
  <em>Télécharger · Traduire · Gagner — le tout sur une seule plateforme</em>
</div>
...
| # | Concurrent | Valeur estimée | Revenus | Utilisateurs | Cible |
|---|-----------|----------------|---------|--------------|-------|
| 1 | **CapCut (ByteDance)** | 225 milliards $ | N/A | 323M MAU | Créateurs occasionnels |
| 2 | **TransPerfect** | ~3–5 milliards $ | 1,32 milliard $ | 6K+ entreprises | Grandes entreprises mondiales |
| 3 | **Iyuno** | ~1,2 milliard $ | 395 millions $ | Studios | Cinéma & TV |
| 4 | **Lionbridge** | ~537 millions $ | 546 millions $ | Fortune 500 | Prestataire linguistique d'entreprise |
| 5 | **OpusClip** | 215 millions $ | ~30 millions $ | 10M+ utilisateurs | Podcasteurs, spécialistes marketing |

### Par innovation en IA
| # | Entreprise | Technologie clé | Soutien |
|---|-----------|-----------------|---------|
| 1 | **Verbit** | ASR propriétaire (juridique, éducation) | 250M+ $, pic à 2 milliards $ |
| 2 | **OpusClip** | IA de viralité, détection d'accroche | 50 millions $ (SoftBank) |
| 3 | **Sonix.ai** | IA pure (10 $/h) | 5,4 millions $ |
| 4 | **Happy Scribe** | IA+humain, 60 langues, 25M $ ARR | Autofinancé |
| 5 | **Flixier** | Éditeur cloud + doublage IA | 120K $ seed |

### Marchés cibles
| Segment | Acteurs clés | Prix d'entrée |
|---------|-------------|---------------|
| **Créateurs occasionnels** | CapCut, OpusClip | Gratuit–15 $/mois |
| **Monteurs vidéo** | Flixier, Maestra | 10–30 $/mois |
| **Entreprises** | TransPerfect, Lionbridge, Verbit | Devis personnalisés |
| **Médias & studios** | Iyuno, 3Play Media | Devis personnalisés |
| **Accessibilité** | 3Play Media, Subly | 0,25–2 $/min |
| **Localisation** | Happy Scribe, Checksub | 17–59 $/mois |

**Nous sommes le seul acteur open-source avec une économie communautaire** — 60 % aux fournisseurs, 20 % aux détenteurs. Et le plus abordable : ~0,06 $/h via le pool Groq contre 0,15–2 $/min pour les concurrents.

> 📊 [Analyse concurrentielle complète →](docs/competition/ANALYSIS.md)
...
**Vous gagnez :** Partagez vos cookies et soyez récompensé à chaque utilisation.
...
**Vous gagnez :** Partagez votre clé API Groq avec le pool. La part du fournisseur (60 % du coût de traduction, répartie entre tous les services utilisés) va aux fournisseurs de clés.

### 3. Traduction
Les sous-titres sont traduits dans la langue cible via DeepSeek (avec un repli local LLaMA prévu).

### 4. Incrustation
Les sous-titres sont incrustés dans la vidéo via FFmpeg. Le support GPU pour les longues vidéos est prévu.
...
> Ce sont les **seuls portefeuilles Subvox officiels**. Nous ne vous demanderons jamais d'envoyer des fonds à une autre adresse. Méfiez-vous des imitateurs.
...
Ajoutez votre clé API Groq au pool communautaire et gagnez une part du **pool de 60 % des fournisseurs** chaque fois que votre clé est utilisée pour la transcription.
...
Certaines plateformes (YouTube, etc.) nécessitent des cookies d'authentification pour télécharger des vidéos. Partagez vos cookies cryptés et gagnez des SUBVOX à chaque utilisation.
...
Détenez des jetons SUBVOX pour gagner une part du **pool de 20 % des détenteurs**, distribué quotidiennement.
...
**Réduction multi-langues :** 20 % de réduction pour chaque langue supplémentaire.
...
|------|---------------|-----------|
| **60 %** | Fournisseurs | Répartie proportionnellement entre les services utilisés : Groq (transcription), DeepSeek (traduction), OpenRouter (vision), cookies (accès à la plateforme) |
...
| Méthode | Description |
|---------|-------------|
| **Contribuer au code** | Soumettez une PR à [subvox-pipeline](https://github.com/Nansoouu/subvox-pipeline) |
| **Partager une clé Groq** | Ajoutez votre clé au pool, gagnez une part du pool de 60 % des fournisseurs |
| **Partager des cookies** | Débloquez des plateformes restreintes et gagnez des récompenses |
| **Signaler des bugs** | Les signalements de bugs valides rapportent des jetons |
...
```
Frontend (Next.js)  -->  API Pipeline (FastAPI)  -->  Travailleur Celery
                                                         |
...
Si vous trouvez cela utile, **donnez une étoile au dépôt** ⭐. Cela prend un clic et cela aide vraiment — cela me dit que ce projet compte pour de vraies personnes, ce qui me motive à continuer à le développer.
