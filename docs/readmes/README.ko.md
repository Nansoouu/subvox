...
| **Groq 키 보유자** | 사용하지 않는 키를 공유하고 번역당 55%를 획득하세요. |
...
### 2. 전사
Groq Whisper를 통해 전사. **커뮤니티 Groq 풀**이 무료 크레딧 제공. 키를 공유하고 비용의 55% 획득.
...
| **Builder** | 1,000,000 SUBVOX + Groq 키 | ×2 | 보상 ×2, Groq 키 +55% |
