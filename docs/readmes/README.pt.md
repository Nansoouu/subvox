...
Leia o README principal em ingles para a versao completa. Aqui estao as informacoes principais em portugues.

## O que e Subvox?

Subvox e um **motor de legendas open-source** para a comunidade. Cole uma URL de video, escolha um idioma e obtenha um video legendado em minutos.

**Mais de 1800 plataformas suportadas** via yt-dlp.

## Por que Subvox?

A traducao de video afeta **bilhoes de pessoas**. Um tutorial coreano, uma conferencia alema, uma aula arabe, um vlog espanhol. O idioma nunca deveria ser uma barreira.

**O problema:** Ferramentas existentes (Veed, Kapwing, Descript, Opus Clip) limitam o tempo, as exportacoes e te prendem em assinaturas caras.

**A solucao:** Uma comunidade descentralizada onde todos ganham.
...
Leia o [README principal](../README.md) para a documentacao completa.
...
> **PONTO DE REFERENCIA OFICIAL**
> Este repositorio e a **unica fonte oficial** da Subvox.
> **Nunca confie em enderecos Subvox encontrados em outro lugar.**
